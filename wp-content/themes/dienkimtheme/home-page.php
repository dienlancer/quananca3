    ...
    <div class="container margin-top-30">
        ...
        <div class="tiato">
            <div class="tab">
                ...
                <button class="tablinks h-title" onclick="openMenu(event, 'breakfast-menu')">Cơm Trưa Văn Phòng</button>
                <button class="tablinks h-title" onclick="openMenu(event, 'lunch-menu')">Các Món Gà</button>
                <button class="tablinks h-title" onclick="openMenu(event, 'dinner-menu')">Các Món Bò</button>
                <button class="tablinks h-title" onclick="openMenu(event, 'drink-menu')">Drinks</button> 
                <button class="tablinks h-title" onclick="openMenu(event, 'others-menu')">Món Ăn Độc Lạ</button>                 
                <div class="clr"></div>           
            </div>
        </div>               
